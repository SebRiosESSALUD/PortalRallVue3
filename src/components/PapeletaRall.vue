      ...
      var docDefinition = {
        ...
        header: {
            columns: [
              ...
              { text: 'RED ASISTENCIAL LA LIBERTAD', margin: [0, 40, 0, 0] , style: 'title' },
            ],
            columnGap: 100
          },
          ...
          content: [
            {
              ...
              style: 'header'
                ...
                {
              stack: [
                'Sr. Jefe de Personal: _______________________________________________ .\n\n',
                
                  'Don(ña): _____________________________________________________________ quien presta servicios\n',
                  'en: _________________________________________________________ a órdenes del suscrito, solicita\n',
                  'permiso por: ________________________________________________ a órdenes del suscrito, solicita\n',
                  'A partir del: _______________________ hasta __________________________ por asusntos motivados:\n',
                  '______________________________________________________________________________________________\n',
                  '______________________________________________________________________________________________\n\n',
                  
                  'Chao, _________ de __________ 202_\n',
              ],
              margin: [0, 20, 0, 0],
              alignment: 'justify'
            },
            ...
            /*PARTE 3*/
            {text: '\n\nCONTROL DE CALIFICACIÓN:',bold:'true'},
            {
          ul: [/*
            'item 1',
        ...
        {
              stack: [
                'SALIÓ: ___________________________________________________________________________ .\n\n',
                  'REGRESÓ: ________________________________________________________________________ .\n\n',
            ...
            columns: [
              {
                width: '*', 
                text: [
                  '(1) Adjuntar constancia de atención\n',
                  '(2) Indicar lugar y motivo de la comisión\n',
                  '(3) Se deberá efectuar la devolución de horas / Reg. Laboral 728 y CAS\n',
                  '(4) Ley Nº28456-TERCERA Disposiciones Transitorias, Complementarias y Finales.\n',
                  '(5) Permiso por Días: Indicar número de días y días de inicio y término (Máx. 10 días)\n',
                  '(6) Permiso por Horas: Indicar el número de horas y hora de salida y entrada\n',
                  '(7) Regularizar posteriormente con resolución\n',
                  '() Indicar solo por comisión de servicios'
                ],
                style: 'footerText'
              }
            ],
...
<template>
  <div class="form-container" style="margin-bottom: 100px;">
    ...
    <div id="formularioSalida" class="p-4 border rounded">
      ...
      <select id="hospitalSelector">
        <option value="HOSPITAL BICENTENARIO DE CHAO">Hospital Bicentenario de Chao</option>
        <option value="RED ASISTENCIAL LA LIBERTAD">Red Asistencial La Libertad</option>
    ...
    <!-- Botón actualizado -->
    <button class="btn btn-primary mt-3" v-on:click.prevent="exportPDF">Generar PDF</button>
  </div>
</template>
